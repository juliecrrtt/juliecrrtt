...
<div class="project-card-horizontal" onclick="window.location='/juliecrrtt/mk-detection/'" style="cursor:pointer;">
...
<div class="project-card-horizontal project-card-inactive">
  <img src="{{ '/assets/images/chocolate.JPG' | relative_url }}" alt="Chocolate">
  <div class="project-content">
